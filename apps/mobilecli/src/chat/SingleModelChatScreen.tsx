  ...
  return (
    <KeyboardAvoidingView style={styles.container} behavior={Platform.OS === 'ios' ? 'padding' : undefined}>
      ...
      <View style={styles.inputRow}>
        <TextInput style={styles.input} value={draft} onChangeText={setDraft} placeholder="Ask the model" multiline />
...
const styles = StyleSheet.create({
  ...
  subtitle: {marginTop: 4, color: '#5b6472'},
  messages: {flex: 1, paddingHorizontal: 16},
  messagesContent: {gap: 8, paddingBottom: 12},
  bubble: {maxWidth: '80%', paddingHorizontal: 12, paddingVertical: 10, borderRadius: 16, backgroundColor: '#ffffff'},
  bubbleText: {color: '#111827'},
  bubbleTextUser: {color: '#ffffff'},
  status: {color: '#4b5563', fontStyle: 'italic'},
  error: {color: '#b91c1c'},
  inputRow: {flexDirection: 'row', alignItems: 'flex-end', gap: 8, padding: 16, borderTopWidth: 1, borderTopColor: '#e5e7eb', backgroundColor: '#ffffff'},
  input: {flex: 1, minHeight: 44, maxHeight: 120, borderWidth: 1, borderColor: '#d1d5db', borderRadius: 12, paddingHorizontal: 12, paddingVertical: 10, backgroundColor: '#f9fafb'},
});
